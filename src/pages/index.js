		  ...
		  <div id="profile"
			  ...
			  <div className="p-4 md:p-12 text-center lg:text-left">
				  <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
					   style={{backgroundImage: `url('/paul.jpeg')`}}/>
				  <h1 className="text-3xl font-bold pt-8 lg:pt-0">Minh T. Phan</h1>
				  ...
				  <p className="pt-8 text-sm">Just passionate about building web application.</p>
				  <div className="pt-12 pb-8">
					  <button className="bg-teal-700 hover:bg-teal-900 text-white font-bold py-2 px-4 rounded-full"
							  onClick={() => window.open('https://www.facebook.com/messages/t/paul.the.phan')}>
						  Get In Touch
					  </button>
				  </div>
				  <div
					  className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
					  <a className="link" href="//fb.me/paul.the.phan" data-tippy-content="@facebook_handle">
					  ...
					  <a className="link" href="https://twitter.com/_paul_phan" data-tippy-content="@twitter_handle">
						  <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img"
					  ...
					  <a className="link" href="https://github.com/paul-phan" data-tippy-content="@github_handle">
						  <svg className="h-6 fill-current text-gray-600 hover:text-teal-700" role="img"
					  ...
					  <a className="link" href="https://www.instagram.com/suppobut/"
					  ...
					  <a className="link" href="https://www.youtube.com/user/phanminh65"
